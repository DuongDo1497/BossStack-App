...
@Component({
  selector: 'app-transfer-cash',
  templateUrl: './transfer-cash.page.html',
  styleUrls: ['./transfer-cash.page.scss'],
})
export class TransferCashPage implements OnInit {
  constructor() {
  ...
  ngOnInit(): void {
    ...
    let ctx4: any = document.getElementById('statistical');
    ctx4.height = 300;
    let statistical = new Chart(ctx4.getContext('2d'), {
      data: {
